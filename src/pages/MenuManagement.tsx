    ...
    <AppLayout>
      <div className="space-y-4">
        ...
        <div className="stat-card grid md:grid-cols-2 gap-3">
          ...
          <FormField label="URL รูปภาพเมนู"><input className="form-input" value={form.imageUrl} onChange={(e) => setForm({ ...form, imageUrl: e.target.value })} placeholder="ใช้ URL ชั่วคราวก่อน Supabase Storage" /></FormField>
          <div className="md:col-span-2 flex gap-2">
            <button className="bg-primary text-primary-foreground px-4 py-2 rounded" onClick={submit}>{form.id ? "บันทึกการแก้ไข" : "เพิ่มเมนู"}</button>
