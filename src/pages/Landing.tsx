...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#f8f4ee] text-slate-900">
      ...
      <footer className="bg-slate-900 text-slate-300"><div className="max-w-6xl mx-auto px-4 py-8"><p className="text-white font-semibold">Valora Engine</p><p className="text-sm mt-1">ระบบปฏิบัติการธุรกิจสำหรับร้านกาแฟ ร้านเครื่องดื่ม และธุรกิจขนาดเล็ก</p><p className="text-sm mt-1">Email: pongsathon.po@kkumail.com</p><p className="text-xs mt-3">© {new Date().getFullYear()} Valora Engine</p></div></footer>
    </div>
  );
}
