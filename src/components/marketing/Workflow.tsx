import { ArrowRight, BadgeCheck, ChefHat, ClipboardCheck, MessageCircle, Receipt, ShoppingBag, Smartphone } from "lucide-react";
...
export default function Workflow() {
  return (
    <section id="workflow" className="border-t py-20 md:py-24">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-12">
          <div className="-mx-4 overflow-x-auto px-4 pb-2 md:overflow-visible">
            <ol className="flex min-w-max items-stretch gap-3 md:grid md:min-w-0 md:grid-cols-4 md:gap-4 lg:grid-cols-8">
              {flow.map((step, i) => (
                <li key={step.label} className="flex items-center gap-3 md:flex-col md:items-stretch md:gap-0">
