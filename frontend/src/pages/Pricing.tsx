...
const FAQS = [
  ...
  },
  {
    ...
    a: "ได้ครับ เจ้าของข้อมูลมีสิทธิขอลบข้อมูลได้ผ่านการติดต่อทีมงาน Valora โดยข้อมูลจะถูกจัดการตามนโยบายและข้อกำหนดที่เกี่ยวข้อง ยกเว้นข้อมูลที่กฎหมายกำหนดให้เก็บรักษา",
  },
  {
...
const PDPA_SECTIONS = [
  ...
  },
  {
    ...
    content: "Valora ไม่ขายหรือนำข้อมูลส่วนบุคคลของผู้ใช้ไปใช้เพื่อวัตถุประสงค์ทางโฆษณาโดยไม่ได้รับความยินยอม การเปิดเผยข้อมูลต่อบุคคลที่สามจะเกิดขึ้นเฉพาะเมื่อมีความจำเป็นทางกฎหมาย หรือเพื่อการให้บริการที่ผู้ใช้ร้องขอ",
  },
  {
  ...
  },
  {
    ...
    content: "ข้อมูลจะถูกเก็บรักษาเท่าที่จำเป็นต่อวัตถุประสงค์ในการให้บริการ การดำเนินงาน การรักษาความปลอดภัย และข้อกำหนดทางกฎหมายที่เกี่ยวข้อง ผู้ใช้สามารถขอให้ลบข้อมูลได้ ยกเว้นข้อมูลที่กฎหมายกำหนดให้จัดเก็บ",
  },
  {
